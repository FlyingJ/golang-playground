...
func Sqrt(x float64) float64 {
	...
	fmt.Printf("%10v%25v\n", "=========", "==================")
	for current_value = starting_value; math.Abs(current_value-previous_value) > epsilon && iteration <= max_iterations; {
		previous_value = current_value
		current_value = previous_value - (previous_value*previous_value-x)/(2*previous_value)
		iteration++
